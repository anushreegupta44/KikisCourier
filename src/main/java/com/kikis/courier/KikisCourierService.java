...
public class KikisCourierService {
  ...
  public void start() {
    ...
    System.out.println("2. Place an order and get price and estimated time of delivery for each parcel");
    Scanner scanner = new Scanner(System.in);
    calculatePrice(scanner);
  }

  private void calculatePrice(Scanner scanner) {
    Order order = getOrderFromInput(scanner);
    pricingService.calculatePriceForOrder(order);
  }

  public Order getOrderFromInput(Scanner scanner) {
